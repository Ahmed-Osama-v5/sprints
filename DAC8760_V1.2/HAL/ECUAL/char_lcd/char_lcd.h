...
#define LCD_RS_PIN	BIT4 	//define MCU pin connected to LCD RS
#define LCD_RS_GPIO	GPIOD

#define LCD_RW_PIN	BIT5 	//define MCU pin connected to LCD R/W
#define LCD_RW_GPIO	GPIOD

#define LCD_EN_PIN	BIT6	//define MCU pin connected to LCD E
#define LCD_EN_GPIO	GPIOD

#define LCD_D4_PIN	BIT7	//define MCU pin connected to LCD D4
#define LCD_D4_GPIO	GPIOD

#define LCD_D5_PIN	BIT0	//define MCU pin connected to LCD D5
#define LCD_D5_GPIO	GPIOB

#define LCD_D6_PIN	BIT0	//define MCU pin connected to LCD D6
#define LCD_D6_GPIO	GPIOC

#define LCD_D7_PIN	BIT1	//define MCU pin connected to LCD D7
...
void LCD_goto_xy(uint8 Col, uint8 Line);	//Cursor to X Y position
